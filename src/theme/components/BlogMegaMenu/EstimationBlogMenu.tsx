    ...
    <ul className="col-10">
      <span className="d-flex align-items-center">
        <li className="m-0 col-6">
          <a
            href="/blog/freelance-marketplace-estimate/"
        ...
        <li className="m-0 col-6">
          <a
            href="/blog/development-cost-to-build-an-app-like-uber/"
            className="nav-dropdown-item d-block mb-1 py-2 px-2"
          >
            <span className="d-flex align-items-center mb-0">
              <span className="col-4 blog-img-holder">
      ...
      <span className="d-flex align-items-center">
        <li className="m-0  col-6">
          <a
            href="/blog/cost-to-build-netflix-like-app/"
            className="nav-dropdown-item d-block mb-1 py-2 px-2"
          >
            <span className="d-flex align-items-center mb-0">
              <span className="col-4 blog-img-holder">
        ...
        <li className="m-0 col-6">
          <a
            href="/blog/cost-to-build-food-delivery-app-like-uber-eats/"
            className="nav-dropdown-item d-block mb-1 py-2 px-2"
          >
            <span className="d-flex align-items-center mb-0">
              <span className="col-4 blog-img-holder">
      ...
      <span className="d-flex align-items-center">
        <li className="m-0 col-6">
          <a
            href="/blog/nft-marketplace-development-cost/"
            className="nav-dropdown-item d-block mb-1 py-2 px-2"
          >
            <span className="d-flex align-items-center mb-0">
              <span className="col-4 blog-img-holder">
