...
description: This tutorial shows you how to send reset password instructions email in React and Rails app. Learn about these steps to reset password for Rails/React app with Devise.
keywords: 'react and rails password reset'
featuredImage: '/images/blogs/reset-password-in-react-and-rails/rails-and-react-password-reset.jpg'
customSlug: 'reset-password-in-react-and-rails'
category: 'Technology'
tags: ['technology', 'react', 'rails']
author: Prabin
type: 'blog-post'
toc: true
featured: false
...
**Note:** You should know the basics of Rails, React, and Devise gem to follow this tutorial.

## Requirements For the Features Were
...
This is how you send a password reset email with custom design and instructions in React and Rails. I hope this article helped you a lot. If you have any suggestions or confusion, please comment below.
