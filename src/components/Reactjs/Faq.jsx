        ...
        <div className='container'>
          <div className='row'>
            <div className='col-sm-12 col-md-7 col-lg-8 mb-5 mb-lg-0'>
              ...
              <AccordionItem>
                <AccordionHeader targetId="1">What is ReactJS and why should I use it?</AccordionHeader>
                <AccordionBody accordionId="1">
                  <p>ReactJS is a JavaScript library for building user interfaces. It allows developers to create reusable components that can be easily composed to build complex user interfaces. Some of the key benefits of using ReactJS include fast performance, a declarative coding style, a large and active community, and the ability to build a wide range of applications.</p>
                </AccordionBody>
              </AccordionItem>
              <AccordionItem>
                <AccordionHeader targetId="2">How long does it take to build a ReactJS application?</AccordionHeader>
                <AccordionBody accordionId="2">
                  <p>The length of time it takes to build a ReactJS application will depend on the specific requirements of the project. Factors that can impact the development timeline include the complexity of the application, the number of features and components that need to be built, and the availability of resources. It's important to work with a development team that can provide a realistic estimate of the timeline and keep the project on track.</p>
                </AccordionBody>
              </AccordionItem>
              <AccordionItem>
                <AccordionHeader targetId="3">How much does it cost to build a ReactJS application?</AccordionHeader>
                <AccordionBody accordionId="3">
                  <p>The cost of building a ReactJS application will also depend on the specific requirements of the project. Factors that can impact the cost include the complexity of the application, the number of features and components that need to be built, and the hourly rate of the development team. It's important to work with a development team that can provide a clear estimate of the project cost and help you understand the trade-offs between different features and priorities.</p>
                </AccordionBody>
              </AccordionItem>
              <AccordionItem>
                <AccordionHeader targetId="4">How does ReactJS different from ReactJS Native?</AccordionHeader>
                <AccordionBody accordionId="4">
                  <p>In ReactJS, virtual DOM is used to render browser code while in React Native, native APIs are used to render components in mobile. The apps developed with ReactJS render HTML in UI while React Native uses JSX for rendering UI.</p>
                </AccordionBody>
              </AccordionItem>
              <AccordionItem>
                <AccordionHeader targetId="5">What is the process for building a ReactJS application?</AccordionHeader>
                <AccordionBody accordionId="5">
                  <p>The process for building a ReactJS application will depend on the specific development team and project, but it generally involves the following steps:</p>
                  <ul className='p-0'>
                    <li>
                      <span className='d-flex'>
                        <span className='me-2'>1.</span>
                        <span>Define the scope and requirements of the project.</span>
                      </span>
                    </li>
                    <li>
                      <span className='d-flex'>
                        <span className='me-2'>2.</span>
                        <span>Design the user interface and user experience.</span>
                      </span>
                    </li>
                    <li>
                      <span className='d-flex'>
                        <span className='me-2'>3.</span>
                        <span>Build the application using ReactJS and any other necessary tools and libraries.</span>
                      </span>
                    </li>
                    <li>
                      <span className='d-flex'>
                        <span className='me-2'>4.</span>
                        <span>Test and debug the application.</span>
                      </span>
                    </li>
                    <li>
                      <span className='d-flex'>
                        <span className='me-2'>5.</span>
                        <span>Deploy the application and provide ongoing maintenance and support.</span>
                      </span>
                    </li>
                  </ul>
                </AccordionBody>
          ...
          <div className="mt-5">
            <div className='position-relative overflow-hidden rounded-3 shadow-lg'>
              <div className="ecommerce-cta d-flex align-items-center flex-column  justify-content-lg-around  process-cta text-center py-4 px-4">
                <h4 className="rm-sm-2 pb-4">Ready to bring your idea to life?</h4>
