        ...
        <div className='container'>
          <div className='row'>
            <div className='col-sm-12 col-md-7 col-lg-8 mb-5 mb-lg-0'>
              ...
              <AccordionItem>
                <AccordionHeader targetId="1">Why should I choose Gatsby for my website?</AccordionHeader>
                <AccordionBody accordionId="1">
                  <p>Gatsby is a great choice for your website because it offers fast performance, a wide range of features, and scalability. It is also easy to use and maintain, making it a good choice for both developers and non-technical users. Overall, Gatsby is a powerful and flexible framework that is well-suited for a wide range of use cases, from simple marketing websites to complex web applications.</p>
                </AccordionBody>
              </AccordionItem>
              <AccordionItem>
                <AccordionHeader targetId="2">How do you build Gatsby websites and what is your process?</AccordionHeader>
                <AccordionBody accordionId="2">
                  <p>To build Gatsby websites, we follow a process that involves planning, development, testing, deployment, and maintenance. We work closely with clients to understand their specific needs and requirements, and use the latest tools and technologies to build high-quality, functional websites that meet their goals.</p>
                </AccordionBody>
              </AccordionItem>
              <AccordionItem>
                <AccordionHeader targetId="3">What sets your company apart from other Gatsby website builders?</AccordionHeader>
                <AccordionBody accordionId="3">
                  <p>Our team of experienced developers and ability to customize our services to meet the specific needs of each project sets us apart from other Gatsby website builders. We also prioritize delivering high-quality, functional websites and offer ongoing support and maintenance.</p>
                </AccordionBody>
              </AccordionItem>
              <AccordionItem>
                <AccordionHeader targetId="4">Can you provide ongoing support and maintenance for my Gatsby website?</AccordionHeader>
                <AccordionBody accordionId="4">
                  <p>Yes, we can provide ongoing support and maintenance for your Gatsby website. Our team of developers is available to address any issues or concerns you may have, and we can work with you to ensure that your website is always up-to-date and performing at its best.</p>
                </AccordionBody>
              </AccordionItem>
              <AccordionItem>
                <AccordionHeader targetId="5">Do you offer any guarantees or warranties for your Gatsby websites?</AccordionHeader>
                <AccordionBody accordionId="5">
                  <p>Yes, we offer guarantees and warranties for our Gatsby websites. We stand behind the quality of our work and are committed to ensuring that our clients are satisfied with the websites we build for them. Depending on the specific terms of your project, we may offer guarantees or warranties related to the performance, functionality, and overall quality of your Gatsby website. Please don't hesitate to contact us to discuss the specific guarantees and warranties that may be available for your project.</p>
                </AccordionBody>
              </AccordionItem>
              <AccordionItem>
                <AccordionHeader targetId="6">How much does it cost to build a Gatsby website with your company?</AccordionHeader>
                <AccordionBody accordionId="6">
                  <p>The cost of building a Gatsby website with our company will depend on a number of factors, including the complexity of the project, the amount of custom development work required, and any additional features or functionality that you may need. In general, prices for Gatsby website development can range from a few thousand dollars for a simple marketing site to tens of thousands of dollars or more for a complex web application. Please don't hesitate to contact us to discuss your specific project and get a more accurate estimate of the cost.</p>
                </AccordionBody>
              </AccordionItem>
          ...
          <div className="mt-5">
            <div className='position-relative overflow-hidden rounded-3 shadow-lg'>
              <div className="ecommerce-cta d-flex align-items-center flex-column  justify-content-lg-around  process-cta text-center py-4 px-4">
                <h4 className="rm-sm-2 pb-4">Ready to build a Gatsby Website?</h4>
